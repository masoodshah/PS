...
#$Url = "https://providentfinancialgroup.sharepoint.com"
$Url = "https://providentfinancialgroup.sharepoint.com/Platform%20Design%20Teamsite/"
$UserName = "masood.shah@provident.co.uk"
$Password = 'Jul2016_01'
$TargetListTitle = "Documents"   #Target Library
$SourceFolderPath = "C:\PS\health\SQL_Server\logs"  #Source Physical Path 
